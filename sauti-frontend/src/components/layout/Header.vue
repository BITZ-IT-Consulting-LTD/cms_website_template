    ...
    <nav class="container-custom py-3">
      <div class="flex items-center justify-between min-h-[64px]">
        ...
        <router-link to="/" class="flex items-center space-x-2">
          <div class="h-8 w-8 rounded-full bg-primary-600 flex items-center justify-center text-white font-bold">S</div>
          <div>
        ...
        <div class="hidden lg:flex flex-1 items-center justify-center gap-8 xl:gap-10 whitespace-nowrap">
          ...
          <router-link to="/reports" class="text-gray-700 hover:text-gray-900 px-2 py-1 rounded-full hover:bg-gray-100">Reports</router-link>
          ...
          <router-link to="/faqs" class="text-gray-700 hover:text-gray-900 px-2 py-1 rounded-full hover:bg-gray-100">FAQs</router-link>
        </div>

        <!-- Right Actions -->
        <div class="hidden lg:flex items-center gap-3 whitespace-nowrap shrink-0">
          <router-link to="/report" class="pill pill-primary">Report Abuse Case</router-link>
        </div>
      ...
      <Transition name="slide">
        <div v-if="mobileMenuOpen" class="lg:hidden mt-4 pb-4 space-y-3">
          ...
          <router-link to="/reports" class="block py-2 text-gray-700 hover:text-gray-900" @click="mobileMenuOpen = false">Reports</router-link>
          ...
          <router-link to="/faqs" class="block py-2 text-gray-700 hover:text-gray-900" @click="mobileMenuOpen = false">FAQs</router-link>

          <div class="pt-3 border-t border-gray-200 flex items-center gap-3">
            <router-link to="/report" class="pill pill-primary w-full text-center" @click="mobileMenuOpen = false">Report Abuse Case</router-link>
          </div>
        </div>
      </Transition>
    </nav>
