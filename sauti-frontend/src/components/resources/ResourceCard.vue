<template>
  <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden group">
    <!-- Thumbnail/Icon -->
    <div class="relative h-48 bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center overflow-hidden">
      <img
      ...
      <div v-else class="text-center">
        <!-- File Type Icon -->
        <svg v-if="resource.file_type === 'pdf'" class="w-20 h-20 mx-auto text-white" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd" />
        </svg>
        <svg v-else-if="resource.file_type === 'doc' || resource.file_type === 'docx'" class="w-20 h-20 mx-auto text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div v-if="resource.category" class="absolute top-3 left-3">
        <span class="inline-block px-3 py-1 text-xs font-semibold bg-white text-teal-600 rounded-full shadow-md">
      ...
      <div v-if="resource.language" class="absolute top-3 right-3">
        <span class="inline-block px-2 py-1 text-xs font-semibold bg-white/90 text-gray-700 rounded-full">
    ...
    <div class="p-5">
      ...
      <a
        ...
        target="_blank"
        class="btn-primary w-full inline-flex items-center justify-center space-x-2 group/btn"
        @click="trackDownload"
      ...
      <!-- Published Date -->
      <div v-if="resource.published_at" class="mt-3 text-xs text-gray-500 text-center">
