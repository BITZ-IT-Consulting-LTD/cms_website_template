<template>
  <div class="space-y-6">
    ...
    <!-- Empty State -->
    <div v-else-if="posts.length === 0" class="bg-primary/5 border border-primary/15 rounded-lg p-12 text-center">
      ...
      <h3 class="text-lg font-semibold text-black/70 mb-2">No Posts Found</h3>
      <p class="text-black/50">Check back later for new content.</p>
    </div>
    ...
    <div v-else>
      ...
      <div v-if="showPagination" class="mt-8 flex justify-center items-center space-x-2">
        <button
          ...
          :class="[
            ...
            hasPrevious
              ...
              : 'bg-secondary/10 text-black/40 cursor-not-allowed'
          ]"
        ...
        <span class="px-4 py-2 text-black/70">
