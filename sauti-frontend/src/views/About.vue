        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div class="lg:col-span-5">
            <div class="card p-0 overflow-hidden">
              <img src="https://images.unsplash.com/photo-1499355942262-97b58a6195b4?q=80&w=1600&auto=format&fit=crop" alt="Children support" class="w-full h-72 md:h-96 object-cover" />
            </div>
          </div>
        </div>
      </div>
