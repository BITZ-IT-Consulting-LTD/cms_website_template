          ...
          <div class="space-y-6">
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:116" class="text-2xl font-bold text-primary-600 hover:text-primary-700">116</a>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="https://wa.me/256123456789" target="_blank" class="text-primary-600 hover:text-primary-700">+256 123 456 789</a>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:info@sauti.mglsd.go.ug" class="text-primary-600 hover:text-primary-700">info@sauti.mglsd.go.ug</a>
              </div>
            </div>
