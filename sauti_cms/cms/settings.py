...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,0.0.0.0,backend,nginx,sauti_backend_dev,sauti.local,sauti.mglsd.go.ug', cast=lambda v: [s.strip() for s in v.split(',')])
