...
urlpatterns = [
    ...
    # Gallery images (must come before slug patterns; keyed by numeric post id)
    path('<int:post_id>/images/', PostImageListCreateView.as_view(), name='post-image-list'),
    path('<int:post_id>/images/<int:pk>/', PostImageDetailView.as_view(), name='post-image-detail'),
